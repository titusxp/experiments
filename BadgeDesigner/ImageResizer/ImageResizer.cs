...
namespace ImageResizer
{
    ...
    public partial class ImageResizer : UserControl
    {
        ...
        public Action<Control> CancelButtonClicked { get; set; }
        ...
        protected void SaveImage()
        {
            try
            {
                ...
                this.ApplyButtonClicked?.Invoke(_editedImage);
            }
            catch (Exception ex)
            {
        ...
        private void pictureBox_RotateLeft_Click(object sender, EventArgs e)
        {
            var image = BaseImage;
        ...
        private void pictureBox_RotateRight_Click(object sender, EventArgs e)
        {
            var image = BaseImage;
